...
class CheckboxFactory {
    static create<T>(): [HTMLElement, Checkbox] {
        ...
        return [htmlElement, new Checkbox(htmlElement.querySelector("input") as HTMLInputElement)]
    }
...
export class TypeSwitchEditor<T extends Terminable> implements Editor<ObservableValue<T>> {
    ...
    constructor(private readonly parentElement: HTMLElement,
        ...
        this.typeValue = this.terminator.with(new ObservableValueImpl(controlBuilder.availableTypes.values().next().value))
