...
export class NumericStepperInput implements Editor<ObservableValue<number>> {
    ...
    constructor(private readonly parent: HTMLElement,
        ...
        this.input = this.parent.querySelector("input[type=text]") as HTMLInputElement
        this.connect()
    }
    ...
    connect() {
        ...
        this.terminator.with(Events.bindEventListener(this.input, "focusin", (focusEvent: Event) => {
